...
function loadGas() {
  ...
  for (const file of ["vendor/alasql.min.js", "generated/nfbAlasqlUdfs.gs", "expressionEvaluator.gs", "templateEvaluator.gs"]) {
...
const cases = [
  ...
  { name: "DATETIME canonical",    template: "{{DATETIME(`d`)}}",                       row: { d: "2020-1-1" }, expected: "2020/01/01 00:00:00.000" },
  ...
  { name: "ERATIME2DATETIME",      template: "{{ERATIME2DATETIME(`d`)}}",               row: { d: "令和元年02月4日 13時" }, expected: "2019/02/04 13:00:00.000" },
