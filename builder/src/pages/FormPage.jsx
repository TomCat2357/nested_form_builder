...
export default function FormPage() {
  ...
  // 新規レコードは開いた時点で本IDを発番（普遍的 eager 発番）。preview / 保存 / pid /
  // 子フォーム / 外部アクションの単一ソースになる。既存レコードは entryId 起点。
  const [currentRecordId, setCurrentRecordId] = useState(() => entryId || genRecordId());
