...
export const DEFAULT_STANDARD_PRINT_FILE_NAME_TEMPLATE = "{`_id`}_{TIME_FORMAT(NOW(), 'YYYY-MM-DD')}";

export const PRINT_TEMPLATE_OUTPUT_OPTIONS = [
  { value: PRINT_TEMPLATE_OUTPUT_TYPES.PDF, label: "PDF" },
  { value: PRINT_TEMPLATE_OUTPUT_TYPES.GOOGLE_DOC, label: "Google ドキュメント" },
