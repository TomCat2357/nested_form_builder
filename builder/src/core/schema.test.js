...
test("normalizeSchemaIDs は fileUpload 設定を allowUploadByUrl へ正規化する", () => {
  const schema = normalizeSchemaIDs([
    { type: "fileUpload", label: "添付資料", allowUploadByUrl: "true", allowFolderUrlEdit: "true", allowMultipleFiles: true, driveRootFolderUrl: "https://drive.google.com/drive/folders/abc", driveFolderNameTemplate: "{@_id}" },
