  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "標準様式出力ファイル名規則",
        placeholder: "{ID}_{_NOW|date:YYYY-MM-DD}",
        required: false,
        description: "GoogleDocument/PDF は「カード個別 > フォーム共通 > 既定値」で解決します。Gmail の PDF 添付はフォーム共通か既定値のみを使い、未入力時の既定値は {ID}_{_NOW|date:YYYY-MM-DD} です",
      },
      {
        key: "saveAfterAction",
        label: "通常保存後の動作",
