...
test("buildPrintDocumentPayload は子フォームセクションを追加できる", () => {
  const payload = buildPrintDocumentPayload({
    schema: [
      { id: "company", type: "text", label: "会社名" },
    ],
    responses: {
      company: "山田製作所",
    },
    ...
    childSections: [
      {
        ...
        entries: [
          {
            recordNo: "11",
            schema: [{ id: "factory_name", type: "text", label: "工場名" }],
            responses: { factory_name: "第一工場" },
          },
          {
            recordNo: "12",
            schema: [{ id: "factory_name", type: "text", label: "工場名" }],
            responses: { factory_name: "第二工場" },
          },
        ],
      },
    ],
  ...
  assert.deepEqual(payload.items, [
    { label: "会社名", value: "山田製作所", depth: 0, type: "text" },
    { label: "工場", value: "", depth: 0, type: "message" },
    { label: "No. 11", value: "", depth: 1, type: "message" },
    { label: "工場名", value: "第一工場", depth: 2, type: "text" },
    { label: "No. 12", value: "", depth: 1, type: "message" },
