...
test("ERATIME2DATETIME: 和暦文字列 → YYYY/MM/DD HH:mm:ss.SSS（部分時刻も解釈。DATETIME canonical なので半角スペースと ms）", () => {
  const fn = setup().ERATIME2DATETIME;
  assert.equal(fn("令和7年5月6日 14:35:48"), "2025/05/06 14:35:48.000");
  assert.equal(fn("令和7年5月6日 14時35分48秒"), "2025/05/06 14:35:48.000");
