...
// ----- 種の表示順（フォーム選択肢順）-----
// >>> shared:chojuDomain (auto-generated by gas_for_external_action/scripts/sync-shared-constants.mjs — do not edit between markers)
...
var CHO_SPECIES_ORDER_ = ["キジバト", "カワラバト", "スズメ", "ニュウナイスズメ", "ハシボソガラス", "ハシブトガラス", "キツネ", "ノイヌ", "ノネコ", "アライグマ", "トガリネズミ科・ネズミ科"];
var CHO_TOOL_ORDER_ = ["手捕り", "くくりわな", "はこわな", "はこおとし", "囲いわな", "むそう網", "はり網", "つき網", "なげ網", "空気銃", "散弾銃", "ライフル銃"];
var CHO_TOOL_KIND_ = { "手捕り": "手捕り", "くくりわな": "わな", "はこわな": "わな", "はこおとし": "わな", "囲いわな": "わな", "むそう網": "網", "はり網": "網", "つき網": "網", "なげ網": "網", "空気銃": "銃器", "散弾銃": "銃器", "ライフル銃": "銃器" };
var CHO_GUN_LIC_ = { "第一種銃猟免許": "第一種銃猟", "第二種銃猟免許": "第二種銃猟" };
// <<< shared:chojuDomain

// 捕獲用具(CHO_TOOL_ORDER_)・方法 kind(CHO_TOOL_KIND_)・銃猟免許(CHO_GUN_LIC_) は
// 上部の shared:chojuDomain マーカー区間で定義（choju_kyokasho と共通・単一ソース）。
