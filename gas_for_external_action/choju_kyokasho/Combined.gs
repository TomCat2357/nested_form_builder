...
var CHO2_SPECIES_ORDER_ = ["キジバト", "カワラバト", "スズメ", "ニュウナイスズメ", "ハシボソガラス", "ハシブトガラス", "キツネ", "ノイヌ", "ノネコ", "アライグマ", "トガリネズミ科・ネズミ科"];
var CHO2_TOOL_ORDER_ = ["手捕り", "くくりわな", "はこわな", "はこおとし", "囲いわな", "むそう網", "はり網", "つき網", "なげ網", "空気銃", "散弾銃", "ライフル銃"];
var CHO2_TOOL_KIND_ = { "手捕り": "手捕り", "くくりわな": "わな", "はこわな": "わな", "はこおとし": "わな", "囲いわな": "わな", "むそう網": "網", "はり網": "網", "つき網": "網", "なげ網": "網", "空気銃": "銃器", "散弾銃": "銃器", "ライフル銃": "銃器" };
...
// 用具（CHO2_TOOL_ORDER_）と方法 kind（CHO2_TOOL_KIND_）・銃猟免許（CHO2_GUN_LIC_）は
// 上部の shared:chojuDomain マーカー区間で定義（choju_yoshiki と共通・単一ソース）。

// ----- 従事者名簿の幾何。1 ブロック = 1 従事者。出力に必要な列のみ（取込側 choju_yoshiki は別途より多くの列を読む） -----
var CHO2_ROSTER_ = {
  sheetName: "従事者名簿",
