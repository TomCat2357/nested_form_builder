...
const ACTION_DEFINITIONS_ = {
  ...
  "analytics_questions_delete_with_files_batch": { handler: AnalyticsApi_DeleteQuestionsWithFiles_, adminOnly: true },
  ...
  "analytics_dashboards_delete_with_files_batch": { handler: AnalyticsApi_DeleteDashboardsWithFiles_, adminOnly: true },
